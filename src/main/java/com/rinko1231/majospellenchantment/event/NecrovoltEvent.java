...
import static com.rinko1231.majospellenchantment.init.EnchantmentRegistry.NECROVOLT_ENCHANT;
...
public class NecrovoltEvent {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        if(!MajoSpellEnchantmentConfig.NecrovoltEnabled.get()) return;
        ...
        int enchantmentLevel =weapon.getEnchantmentLevel(
                Objects.requireNonNull(CommonHooks.resolveLookup(Registries.ENCHANTMENT)).getOrThrow(NECROVOLT_ENCHANT)
        );
        ...
        AttributeInstance attr = player.getAttribute(AttributeRegistry.LIGHTNING_SPELL_POWER);
