...
public class MajoSpellEnchantment {
    ...
    public MajoSpellEnchantment(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.register(new VladTepesEvent());
        NeoForge.EVENT_BUS.register(new RedLotusEvent());
        NeoForge.EVENT_BUS.register(new ManaMendingEvent());
        NeoForge.EVENT_BUS.register(new GentleGraveyardKeeperEvent());
        NeoForge.EVENT_BUS.register(new ExcitatioArcanaEvent());
        NeoForge.EVENT_BUS.register(new IceFireSongEvent());
        NeoForge.EVENT_BUS.register(new NecrovoltEvent());
        NeoForge.EVENT_BUS.register(new LichKingEvent());
        //NeoForge.EVENT_BUS.register(new MorningHazeEvent());
