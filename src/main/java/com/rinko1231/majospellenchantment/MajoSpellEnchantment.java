...
public class MajoSpellEnchantment {
    ...
    public MajoSpellEnchantment() {
        ...
        MinecraftForge.EVENT_BUS.register(new VladTepesEvent());
        MinecraftForge.EVENT_BUS.register(new RedLotusEvent());

        MinecraftForge.EVENT_BUS.register(new ManaMendingEvent());
        MinecraftForge.EVENT_BUS.register(new NecrovoltEvent());
