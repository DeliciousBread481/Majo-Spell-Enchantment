...
public class ModEnchantments {
    ...
    static {
        ...
        VLAD_TEPES_ENCHANT = ENCHANTMENTS.register("vlad_tepes_enchant", VladTepes::new);
        RED_LOTUS_ENCHANT = ENCHANTMENTS.register("red_lotus_enchant", RedLotus::new);

        MANA_MENDING_ENCHANT = ENCHANTMENTS.register("mana_mending_enchant", ManaMending::new);

        NECROVOLT_ENCHANT = ENCHANTMENTS.register("necrovolt_enchant", Necrovolt::new);
